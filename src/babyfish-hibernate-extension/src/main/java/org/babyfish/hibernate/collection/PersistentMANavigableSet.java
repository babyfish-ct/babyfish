...
implements PersistentCollection<E>, WrapperCollectionAware<E>, Serializable {
    ...
    @Override
    public void setWrapperCollection(AbstractWrapperXCollection<E> wrapperCollection) {
        AssociatedEndpoint oldWrapperEndpoint = this.wrapperEndpoint;
        if (oldWrapperEndpoint != wrapperCollection) {
            if (wrapperCollection instanceof AssociatedEndpoint) {
                this.wrapperEndpoint = (AssociatedEndpoint)wrapperCollection; 
            } else {
