...
public class EntityOrderedMap<K, V> extends AssociatedOrderedMap<K, V> implements ModelPersistentCollection {

    private static final long serialVersionUID = -1746674470736894533L;
    
    private boolean inverse;
    
    public EntityOrderedMap(ObjectModel objectModel, int propertyId) {
