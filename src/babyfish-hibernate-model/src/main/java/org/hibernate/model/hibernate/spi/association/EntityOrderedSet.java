...
public class EntityOrderedSet<E> extends AssociatedOrderedSet<E> implements ModelPersistentCollection {

    private static final long serialVersionUID = -1746674470736894533L;
    
    private boolean inverse;
    
    public EntityOrderedSet(ObjectModel objectModel, int propertyId) {
