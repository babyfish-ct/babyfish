 ...
 * for more details.
 */
package org.babyfish.model.unidirectional.entities;
...
public class XProduct extends Product {
    ...
    @Contravariance(from = "manufacturer")
    private XManufacturer xManufacturer;

    public XManufacturer getXManufacturer() {
        return xManufacturer;
    }

    public void setXManufacturer(XManufacturer xManufacturer) {
