 ...
 * @author Tao Chen
 */
public class IteratorModifications {
    
    public static <E> Remove<E> remove() {
        return new Remove<>();
    }

    public static class Remove<E> extends AbstractModification implements Modification<E> {

        private static final long serialVersionUID = -7442399364228337719L;
